...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 56, ; uint32_t number_of_dso_cache_entries (0x38)
...
@dso_cache = dso_local local_unnamed_addr global [56 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.13_name, ; name: libMicrosoft.CognitiveServices.Speech.extension.lu.so
		ptr null; void* handle (0x0)
	}, ; 1
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libMicrosoft.CognitiveServices.Speech.core.so
		ptr null; void* handle (0x0)
	}, ; 3
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libMicrosoft.CognitiveServices.Speech.extension.audio.sys.so
		ptr null; void* handle (0x0)
	}, ; 6
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.11_name, ; name: libMicrosoft.CognitiveServices.Speech.extension.kws.ort.so
		ptr null; void* handle (0x0)
	}, ; 21
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.12_name, ; name: libMicrosoft.CognitiveServices.Speech.extension.kws.so
		ptr null; void* handle (0x0)
	}, ; 25
	%struct.DSOCacheEntry {
...
@.env.7 = private unnamed_addr constant [37 x i8] c"6937f60e-f4ee-4fff-b257-c3f44afee08d\00", align 1
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [27 x i8] c"com.companyname.memory_key\00", align 1
...
@.DSOCacheEntry.9_name = private unnamed_addr constant [46 x i8] c"libMicrosoft.CognitiveServices.Speech.core.so\00", align 1
@.DSOCacheEntry.10_name = private unnamed_addr constant [61 x i8] c"libMicrosoft.CognitiveServices.Speech.extension.audio.sys.so\00", align 1
@.DSOCacheEntry.11_name = private unnamed_addr constant [59 x i8] c"libMicrosoft.CognitiveServices.Speech.extension.kws.ort.so\00", align 1
@.DSOCacheEntry.12_name = private unnamed_addr constant [55 x i8] c"libMicrosoft.CognitiveServices.Speech.extension.kws.so\00", align 1
@.DSOCacheEntry.13_name = private unnamed_addr constant [54 x i8] c"libMicrosoft.CognitiveServices.Speech.extension.lu.so\00", align 1
